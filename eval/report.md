...
_Generated 2026-09-19T11:50:59+00:00 · golden set: 40 questions · primary k = 5 · token counts approximate (heuristic)._

## Configuration comparison

| Config | Routing acc | P@5 | R@5 | F1@5 | Faithfulness | Refusal acc | p50 ms | p95 ms | $/query | Errors |
|---|---|---|---|---|---|---|---|---|---|---|
| hybrid | 1.00 | 1.00 | 0.99 | 1.00 | n/a | 1.00 | 0 | 0 | 0.00001 | 0 |
| dense_only | 1.00 | 1.00 | 0.99 | 1.00 | n/a | 1.00 | 0 | 0 | 0.00001 | 0 |
...
- **Citation faithfulness (LLM judge):** not evaluated (judge disabled or no cited answers)
- **Latency:** mean=0ms, p50=0ms, p95=0ms, max=0ms
- **Cost:** total=$0.0003, mean=$0.00001/query, tokens in/out=841/224
